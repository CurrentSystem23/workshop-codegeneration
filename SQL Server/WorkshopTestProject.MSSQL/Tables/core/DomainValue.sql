...
(
    ...
    [TenantId]     BIGINT         NOT NULL CONSTRAINT [fk_CoreDomainValue_CoreTenant_TenantId] FOREIGN KEY ([TenantId]) REFERENCES [core].[Tenant] ([Id])
);
GO
...
CREATE INDEX [ix_coreDomainValue_TenantId] ON [core].[DomainValue] ([TenantId]);
GO

...
(
    ...
    [TenantId]              BIGINT           NOT NULL CONSTRAINT [fk_CoreUser_CoreTenant_TenantId] FOREIGN KEY ([TenantId]) REFERENCES [core].[Tenant] ([Id]),
...
CREATE INDEX [ix_coreUser_TenantId] ON [core].[User] ([TenantId]);
GO

CREATE INDEX [ix_coreUser_State] ON [core].[User] ([State]);
GO

CREATE INDEX [ix_coreUser_BusinessPartnerId] ON [core].[User] ([BusinessPartnerId]);
GO
